...
export default function HelpPrivateChatsPage({ visible, onClose, onSearch, openBug}) {
    const search = () => {
        onClose();
        onSearch()
    }
            ...
            <TouchableOpacity style={styles.page} onPress={() => onClose()} activeOpacity={1}>
                <TouchableOpacity style={styles.container} activeOpacity={1}>
                    ...
                    <View style={styles.content}>
                        ...
                        <SubTitle style={styles.subtitle} size={16}>must have their exact username to do so.</SubTitle>
                    </View>
