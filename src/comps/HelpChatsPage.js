            ...
            <TouchableOpacity style={styles.page} onPress={() => onClose()} activeOpacity={1}>
                <TouchableOpacity style={styles.container} activeOpacity={1}>
                    <View style={styles.header}>
                        <IconButton color={colors.background} icon="bug" brand="Ionicons" size={32}/>
                        <SubTitle color={colors.pBeamBright} style={styles.title} size={18}>What are chats near you?</SubTitle>
                        <IconButton color={colors.text1} icon="ios-close-circle" brand="Ionicons" size={32} onPress={onClose} />
                    </View>
                    <View style={styles.content}>
                        <SubTitle color={colors.pBeamBright} style={styles.title} size={16}>They are public</SubTitle>
                    ...
                    <View style={styles.content}>
                        <SubTitle color={colors.pBeamBright} style={styles.title} size={16}>They aren't permanent</SubTitle>
